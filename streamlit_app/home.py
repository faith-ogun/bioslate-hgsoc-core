...
with col1:
    st.image("streamlit_app/assets/gene_biomarker.png", width=300)
...
with col2:
    st.image("streamlit_app/assets/synthetic_lethality.png", width=300)
...
with col3:
    st.image("streamlit_app/assets/responder-non-responder.png", width=300)
