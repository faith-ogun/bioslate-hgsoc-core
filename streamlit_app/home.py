...
with col1:
    ...
    st.write(
        ...
        "and protein expression changes in HGSOC. Discover potential biomarkers and therapeutic targets "
        "by analysing statistical significance and effect sizes across samples."
    )
